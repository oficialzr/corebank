...
def list_transactions(user_id: str, limit: int | None = None, offset: int = 0) -> list[TransactionResponse]:
    return transactions_repository.get_transactions_by_user_id(user_id, limit, offset)
...
def list_transactions_by_account_id(
    account_id: str, user_id: str, limit: int | None = None, offset: int = 0
) -> list[TransactionResponse]:
    return transactions_repository.get_transactions_by_account_id_and_user_id(
